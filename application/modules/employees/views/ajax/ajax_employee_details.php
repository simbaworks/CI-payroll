...
<div class="row">
	<div class="col-12">
		<a class="btn btn-info btn-sm btn-flat float-right" href="<?php echo site_url($controller . '/ajax_download_employee_details/' . base64_encode($employee_details['id']));?>"><i class="fas fa-print mr-2"></i> Print</a>
</div>