<form method="post" action="#" id="ajax-employee-details-add-form">	
	<div class="row">
	            ...
	            <select class="form-control ajax-form-row" id="<?php echo $field_name; ?>" name="<?php echo $field_name; ?>" data-field-name="Posting">
					...
					<?php if(isset($centre_details)){?>
						<?php foreach($centre_details as $cd){?>
							<option value="<?php echo $cd['id'];?>"><?php echo base64_decode($cd['centre_name']) . ' - ' . base64_decode($cd['centre_type_name']) . '(' . base64_decode($cd['ro_name']) . ')';?></option>
						<?php }?>
					<?php }?>
				</select>
	  		</div>
	            ...
	            <select class="form-control ajax-validation-require ajax-form-row" id="<?php echo $field_name; ?>" name="<?php echo $field_name; ?>" data-field-name="Employee Type">
					...
					<?php if(isset($employee_types)){?>
						<?php foreach($employee_types as $et){?>
							<option value="<?php echo $et['id'];?>"><?php echo base64_decode($et['type_name']);?></option>
						<?php }?>
					<?php }?>
				</select>
	  		</div>
		...
		<div class="col-12">
	  		<div class="form-group mb-3 esic-div d-none">
	            <?php $field_name = 'esic_number'; $max_length = '200'; $validation_type_class = 'alphabets'; $type = 'text'; ?>
	            ...
	            <input type="<?php echo $type; ?>" maxlength="<?php echo $max_length; ?>" data-field-name="ESIC Number" id="<?php echo $field_name; ?>" name="<?php echo $field_name; ?>" class="form-control ajax-validation-require ajax-form-row d-none">
	  		</div>
	    </div>
	</div>
	<div class="row">
	            ...
	            <select class="form-control ajax-validation-require ajax-form-row" id="<?php echo $field_name; ?>" name="<?php echo $field_name; ?>" data-field-name="Designation">
					...
					<?php if(isset($designation_master)){?>
						<?php foreach($designation_master as $designation){?>
							<option value="<?php echo $designation['id'];?>"><?php echo $designation['description'] . '(' . $designation['type'] . ') - ' . $designation['shortname'];?></option>
						<?php }?>
					<?php }?>
				</select>
	  		</div>
	            ...
	            <select class="form-control ajax-form-row" id="<?php echo $field_name; ?>" name="<?php echo $field_name; ?>" data-field-name="Reporting Officer">
					...
					<?php if(isset($employees)){?>
						<?php foreach($employees as $ro){?>
							<option value="<?php echo $ro['id'];?>"><?php echo base64_decode($ro['emp_name']);?></option>
						<?php }?>
					<?php }?>
				</select>
	  		</div>
		...
		<div class="col-6">
	  		<div class="form-group mb-3">
	            <?php $field_name = 'service_book_no'; $max_length = '200'; $validation_type_class = 'alphabets'; $type = 'text'; ?>
	            ...
	            <input type="<?php echo $type; ?>" maxlength="<?php echo $max_length; ?>" data-field-name="Service Book Number" id="<?php echo $field_name; ?>" name="<?php echo $field_name; ?>" class="form-control ajax-form-row">
	  		</div>
	    </div>
		<!-- <div class="col-6">
	  		<div class="form-group mb-3">
	            ...
	            <input type="<?php echo $type; ?>" maxlength="<?php echo $max_length; ?>" data-field-name="Pension Account Number" id="<?php echo $field_name; ?>" name="<?php echo $field_name; ?>" class="form-control ajax-validation-require ajax-form-row">
	  		</div>
	    </div> -->
		<div class="col-6">
	  		<div class="form-group mb-3">
	            ...
	            <input type="<?php echo $type; ?>" maxlength="<?php echo $max_length; ?>" data-field-name="Co-Opp Account Number" id="<?php echo $field_name; ?>" name="<?php echo $field_name; ?>" class="form-control ajax-validation-require ajax-form-row">
	  		</div>
	    </div>
		<!-- <div class="col-6">
	  		<div class="form-group mb-3">
	            ...
	            <select class="form-control ajax-validation-require ajax-form-row" id="<?php echo $field_name; ?>" name="<?php echo $field_name; ?>" data-field-name="Union">
					...
					<?php if(isset($unions)){?>
						<?php foreach($unions as $value){?>
							<option value="<?php echo $value['id'];?>"><?php echo base64_decode($value['union_name']);?></option>
						<?php }?>
					<?php }?>
				</select>
	  		</div>
	...
	<div class="row">
	    <div class="col-12">
	    	<div class=" text-right">
	            ...
	            <button class="btn btn-outline-primary my-2 btn-sm save-employee-ajax-form-data btn-flat" type="submit" form-type="official"><i class="fa fa-save mr-1"></i> Save</button>
	        </div>
	    </div>
	</div>
</form>
