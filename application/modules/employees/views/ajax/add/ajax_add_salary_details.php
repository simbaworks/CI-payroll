	...
	<div class="row">	
	            ...
	            <select class="form-control ajax-validation-require ajax-form-row salary-designation" id="<?php echo $field_name; ?>" name="<?php echo $field_name; ?>" data-field-name="Designation">
					...
					<?php if(isset($designation_pay_scale)){?>
						<?php foreach($designation_pay_scale as $dps){?>
							...
							<option value="<?php echo $dps['designation_id'];?>"><?php echo $dps['description'];?></option>
						<?php }?>
					<?php }?>
				</select>
	  		</div>
		...
		<div class="col-6">
	  		<div class="form-group mb-3">
	            ...
	            <select class="form-control ajax-validation-require ajax-form-row" id="<?php echo $field_name; ?>" name="<?php echo $field_name; ?>" data-field-name="Scale">
					...
					<?php if(isset($designation_pay_scale)){?>
						<?php foreach($designation_pay_scale as $dps){?>
							<option value="<?php echo $dps['id'];?>" class="scale-options <?php echo 'designation-' . $dps['designation_id'];?> d-none"><?php echo $dps['pay_pattern'] . '(' . $dps['scale_min'] . ' - ' . $dps['scale_max'] . ')';?></option>
						<?php }?>
					<?php }?>
				</select>
	  		</div>
		...
		<div class="col-6">
	  		<div class="form-group mb-3">
	            ...
	            <input type="<?php echo $type; ?>" maxlength="<?php echo $max_length; ?>" data-field-name="Basic salary" id="<?php echo $field_name; ?>" name="<?php echo $field_name; ?>" class="form-control ajax-form-row ajax-validation-require">
	  		</div>
	    </div>	
		<div class="col-6">
	  		<div class="form-group mb-3">
	            ...
	            <input type="<?php echo $type; ?>" maxlength="<?php echo $max_length; ?>" data-field-name="Special Pay" id="<?php echo $field_name; ?>" name="<?php echo $field_name; ?>" class="form-control ajax-form-row">
	  		</div>
	    </div>
		<div class="col-6">
	  		<div class="form-group mb-3">
	...
	<div class="row">
	    <div class="col-12">
	    	<div class="text-right">
	            ...
	            <button class="btn btn-outline-primary my-2 btn-sm save-employee-ajax-form-data btn-flat" type="submit" form-type="salary"><i class="fa fa-save mr-1"></i> Save</button>
	        </div>
	    </div>
	</div>
</form>