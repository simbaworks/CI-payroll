          		...
          		<?php if(isset($results)){$i = $offset + 1;?>
          			<?php foreach ($results as $value) {?>
            			<tr>
							<td><?php echo $i;?></td>
							<td>
								<input type="text" class="form-control auto-update-content-enc" placeholder="Board/University" value="<?php echo base64_decode($value['bu_name']);?>" data-row-id="<?php echo base64_encode($value['id']);?>" data-row-field="bu_name">
							</td>
