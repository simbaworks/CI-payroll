...
(function ($) {
    ...
    $.fn.tagEditorInput = function () {
        var t = " ", e = $(this), n = parseInt(e.css("fontSize")), i = $("<span/>").css({position: "absolute", top: -9999, left: -9999, width: "auto", fontSize: e.css("fontSize"), fontFamily: e.css("fontFamily"), fontWeight: e.css("fontWeight"), letterSpacing: e.css("letterSpacing"), whiteSpace: "nowrap"}), s = function () {
            if (t !== (t = e.val())) {
                i.text(t);
                var s = i.width() + n;
    ...
    $.fn.tagEditor = function (options, val, blur) {
        ...
        return selector.each(function () {
            ...
            // helper: update global data
            // CUSTOM FUNCTION 29-03-2019
            function set_readonly() {
                if (o.readOnly){
                    $(o.target).siblings('ul').find('.tag-editor-delete').click(function( event ) {
                        event.stopPropagation();
                    });
                    $(o.target).siblings('ul').sortable().sortable("disable");
                    ed.find('input').blur();
                    return false;
                }
            }
            
            function set_fixedTags() {
                if (o.fixedTags){
                    $(o.target).siblings('ul').find('.tag-editor-delete').click(function( event ) {
                        event.stopPropagation();
                    });
                ...
                // tab key
                    ...
                    if (e.shiftKey) {
                        ...
                        if (next_tag.length)
                            ...
                            return; // allow tabbing to next element
                        return false;
                    }
                }
                // del key
