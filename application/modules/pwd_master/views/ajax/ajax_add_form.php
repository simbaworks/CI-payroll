	...
	<div class="row">
		<div class="col-12">
	  		<div class="form-group mb-3">
	            <?php $field_name = 'pwd_name'; $max_length = '200'; $validation_type_class = 'alphabets'; $type = 'text'; ?>
	            <label for="<?php echo $field_name; ?>">PWD Name <span id="<?php echo 'err_' . $field_name; ?>" class="invalid-feedback small"></span></label>
